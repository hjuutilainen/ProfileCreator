...
+ (void)createPayloadForCellType:(NSDictionary *)manifestContentDict manifest:manifest settings:(NSDictionary *)settings payloads:(NSMutableArray **)payloads sender:(PFCProfileExport *)sender {
