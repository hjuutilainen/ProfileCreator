...
NSString *const PFCManifestKeyAvailabilityKey = @"AvailabilityKey";
NSString *const PFCManifestKeyAvailabilityValue = @"AvailabilityValue";
NSString *const PFCManifestKeyAvailabilityOS = @"AvailabilityOS";
NSString *const PFCManifestKeyAvailabilitySelectionIdentifier = @"SelectionIdentifier";
NSString *const PFCManifestKeyAvailabilitySelectionValue = @"SelectionValue";
NSString *const PFCManifestKeyAvailableFrom = @"AvailableFrom";
NSString *const PFCManifestKeyAvailable = @"Available";
NSString *const PFCManifestKeyAvailableTo = @"AvailableTo";
NSString *const PFCManifestKeyAvailableIf = @"AvailableIf";
...
NSString *const PFCSettingsKeyValueRadioButton = @"ValueRadioButton";
